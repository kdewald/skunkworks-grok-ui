...
# DMG:   src-tauri/target/release/bundle/dmg/Skunkworks Grok UI_0.3.1_*.dmg
```
...
6. Open the **terminal** from the icon in the top-right of the chat header. Use **+** in the terminal tab bar for additional shells.
